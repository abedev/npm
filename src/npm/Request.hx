...
extern class Request {
  @:selfCall static function request(options : RequestOptions, callback : Callback2<js.node.http.ServerResponse, Dynamic>) : Void;
  @:selfCall static function async(url : String, callback : Callback2<js.node.http.ServerResponse, Dynamic>) : Void;
